...
public class Kuiz3Fragment extends Fragment {

    public Kuiz3Fragment() {
    ...
    public View onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_kuiz3, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnTidak.setOnClickListener(v ->{
            Navigation.findNavController(v).navigate(R.id.action_to_kuiz4Fragment);
        });
