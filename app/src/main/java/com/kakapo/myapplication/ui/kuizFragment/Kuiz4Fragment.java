...
public class Kuiz4Fragment extends Fragment {
    public Kuiz4Fragment() {
    ...
    public View onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_kuiz4, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnTidak.setOnClickListener(v ->{
            Navigation.findNavController(v).navigate(R.id.action_to_hasilNegatifFragment);
        });
